...
data class PokemonResponse(
    ...
    val pastTypes: List<@RawValue Any?>? = null,
...
data class UltraSunUltraMoon(
    ...
    val frontShinyFemale: @RawValue Any? = null,

    @field:SerializedName("front_default")
    val frontDefault: String? = null,

    @field:SerializedName("front_female")
    val frontFemale: @RawValue Any? = null,
...
data class Animated(
    ...
    val backShinyFemale: @RawValue Any? = null,

    @field:SerializedName("back_female")
    val backFemale: @RawValue Any? = null,
